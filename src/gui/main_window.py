...
_SHARD_S2_A = bytes([239, 226, 222, 132, 154, 148, 44, 145, 207, 72, 218, 29, 4, 33, 23, 188, 168, 97, 6, 239, 141, 139, 6, 12, 133, 244, 154, 1, 5, 235, 175, 177])
_SHARD_S2_B = bytes([135, 112, 236, 218, 47, 96, 8, 86, 79, 212, 194, 162, 167, 166, 179, 100, 222, 51, 57, 181, 40, 120, 59, 146, 254, 196, 167, 131, 171, 51, 226, 245])
_SHARD_S2_C = bytes([189, 140, 227, 230, 233, 30, 27, 34, 166, 123, 234, 51, 118, 19, 151, 190, 153, 234, 159, 45, 124, 42, 118, 5, 54, 188, 93, 136, 19, 209, 166, 84])
...
def _shard_s2_check():
    ...
    if not _s2_helpers._is_frozen():
        return
    path = _s2_helpers.get_resource_path('src/gui/ui/intersection-polyfill.js')
    try:
